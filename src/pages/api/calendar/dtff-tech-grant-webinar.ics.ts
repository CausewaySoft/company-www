...
export const GET = async () => {
  try {
    ...
    const description =
      "Don't miss this opportunity! Get up to £20k to Digitally Transform your business with the DTFF. Take the first step toward a digitally empowered future! Contact CausewaySoft now! office@causewaysoft.com";
